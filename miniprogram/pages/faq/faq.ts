  ...
  data: {
    ...
    faqList: [
      ...
      },
      {
        category: '盖章问题',
        q: '我的社团应该找哪个部门盖章？',
        a: '年审盖章须找归口管理单位（即社团的归属单位），归属单位是谁就找谁盖章。例如：体育类社团→体育教学部。具体归属可在"我的"页面查看，如有疑问联系社联确认。',
      },
      {
        category: '盖章问题',
        q: '为什么我的年审表没有盖章？',
        a: '年审为电子版审核流程，电子文档本身不含印章。请先在"进度查询"确认审核是否通过，通过后系统会提示归口盖章部门，再携带纸质版前往对应部门盖章。',
      },
      {
        category: '私章申请',
        q: '社团可以自己刻章吗？',
        a: '不可以！社团不具有法人资格，任何私自刻制的公章或制作的电子印章均无法律效力，年审中将被直接判定为违规。请务必通过归口管理单位正规盖章。',
      },
      {
        category: '私章申请',
        q: '使用电子印章（PS贴图）可以吗？',
